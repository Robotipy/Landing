...
const casosDeExito = [
  {
    ...
    challenge:
      "Reportes semanales de costos desde SAP tomaban horas y dependían de una sola persona.",
  ...
  },
  {
    ...
    challenge:
      "Tres sistemas desconectados con ingreso manual de datos propenso a errores de transcripción.",
  ...
  },
  {
    ...
    challenge:
      "Monitoreo diario de precios de commodities y datos macro de 10+ fuentes públicas de forma manual.",
  ...
  },
  {
    ...
    challenge:
      "Conciliaciones bancarias y revisión de facturas manuales entre múltiples bancos y sistemas.",
  ...
  },
  {
    ...
    challenge:
      "Carga manual diaria de cartolas bancarias y gestión de factoring en múltiples monedas.",
  ...
  },
  {
    ...
    challenge:
      "Conciliación manual entre múltiples bancos y ERP con operaciones dispersas geográficamente.",
        ...
        <div className="flex items-end justify-between mb-8">
          <div>
            ...
            <p className="mt-2 text-sm text-gray-400 max-w-lg">
              Ejemplos concretos de automatización en empresas de Latinoamérica.
            </p>
          </div>
