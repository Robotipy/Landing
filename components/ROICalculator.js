...
const ROICalculator = () => {
  ...
  return (
    <div className="bg-white dark:bg-slate-800/50 rounded-xl my-16 p-8 lg:p-12">
      <div className="max-w-[720px] mx-auto text-center mb-8">
        ...
        <p className="text-text-light dark:text-text-dark text-lg mt-2">
      ...
      <div className="grid md:grid-cols-2 gap-8 items-center">
        ...
        <div className="text-center bg-background-light dark:bg-background-dark p-8 rounded-lg">
          <h3 className="text-text-light dark:text-text-dark text-lg font-medium">
          ...
          <button
            ...
            className="w-full bg-accent hover:bg-accent/90 text-white font-bold py-3 px-6 rounded-lg transition-colors"
          >
