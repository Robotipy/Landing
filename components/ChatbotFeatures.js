    ...
    <section className="py-16 lg:py-24 bg-white dark:bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 max-w-5xl mx-auto leading-relaxed">
            ¿Cansado de navegar sistemas ERP complejos y dejar a los clientes esperando? Nuestros asistentes conversacionales con IA se conectan 
