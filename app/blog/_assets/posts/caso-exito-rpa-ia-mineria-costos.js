...
export const post = {
  ...
  title: "Caso de Éxito: RPA + Agente IA para reportes de costos en minería del cobre",
  description:
    "Cómo una empresa minera de cobre en Chile automatizó sus reportes de costos con RPA y un agente de IA que responde preguntas en lenguaje natural, eliminando el key-person risk.",
  categories: [
  ...
  content: (
    <>
      <section className="space-y-3">
        ...
        <p className={styles.p}>
          Este caso de éxito muestra cómo una <strong>empresa minera de cobre con operaciones en el norte de Chile</strong> transformó su acceso a información de costos mediante la combinación de <strong>RPA (Robotic Process Automation)</strong> y un <strong>agente de inteligencia artificial</strong>.
        </p>
      </section>

      <section className="space-y-3">
        <h3 className={styles.h3}>El Desafío: Reportes manuales y dependencia de una sola persona</h3>
        <p className={styles.p}>
      ...
      <section className="space-y-3">
        <h3 className={styles.h3}>La Solución: Robot RPA + Agente IA</h3>
        <p className={styles.p}>
          Implementamos una solución en dos capas que transformó completamente el acceso a información de costos:
        </p>
      ...
      <section className="space-y-3 p-6 rounded-xl border-l-4 border-cyan-400" style={{ backgroundColor: "rgba(3, 150, 149, 0.1)" }}>
        ...
        <p className={styles.p}>
          El mayor valor no fue automatizar el reporte sino descubrir que <strong>nadie lo leía cuando se enviaba por correo</strong>. La cliente nos dijo: &quot;Les mando un PDF de tres hojas y nadie lo mira.&quot;
        </p>
        <p className={styles.p}>
