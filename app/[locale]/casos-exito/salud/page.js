  ...
  const successCases = [
    {
      ...
      industry: "Salud",
      challenge:
        "Capacitación manual de usuarios en el Programa PDD (Programa de Desarrollo Digital) para asociaciones de clínicas, proceso repetitivo y extenso.",
      solution:
        "Automatización del programa de capacitación PDD para asociaciones de clínicas, optimizando el proceso de formación de usuarios en herramientas digitales.",
      results: {
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Descubre cómo hemos optimizado los procesos de salud a través de la automatización inteligente, mejorando la capacitación y gestión de clínicas.
              </p>
            </div>
          </div>
        </section>
