      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <div style="background-color: #f5f5f5; padding: 20px; border-radius: 8px;">
            ...
            <p><strong>Cargo:</strong> ${escapeHtml(body.role) || 'No proporcionado'}</p>
            <p><strong>Tamaño de Empresa:</strong> ${escapeHtml(body.companySize) || 'No proporcionado'}</p>
            <p><strong>Sitio Web:</strong> ${escapeHtml(body.website) || 'No proporcionado'}</p>
            <p><strong>Información Adicional:</strong> ${escapeHtml(body.additionalInfo) || 'No proporcionado'}</p>
